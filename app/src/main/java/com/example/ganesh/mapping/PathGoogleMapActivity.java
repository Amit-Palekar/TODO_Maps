...
/**
 * Created by ganesh on 6/12/2016.
 */
...
//    }
    ...
    public ReadTask makeTask() {
        return new ReadTask();
    }

    public String getMapsApiDirectionsUrl(LatLng[] array, String str) {
        System.out.println("str: " + str);
        String waypoints = "origin="
                + array[0].latitude + "," + array[0].longitude
                + "&waypoints=|" + "|" + array[1].latitude + ","
                + array[1].longitude + "|" + array[2].latitude + ","
                + array[2].longitude + "&destination=" + array[0].latitude + "," + array[0].longitude;

        String sensor = "mode=" + str + "&key=AIzaSyCWOLNlo1FoAg96eZlNsdyj8iK5S7TwQgo";
